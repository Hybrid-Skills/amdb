...
export function WatchProviders({ providers, title, className }: WatchProvidersProps) {
  ...
  return (
    <div
      className={cn(
        'flex items-center overflow-x-auto no-scrollbar gap-4 flex-nowrap py-0 select-none',
        className,
      )}
    >
      <div className="flex items-center gap-2.5 flex-nowrap">
        {!hasFlatrate && hasRentBuy && (
          <span className="text-[10px] font-black uppercase tracking-widest text-white/30 whitespace-nowrap shrink-0">
            Rent/Buy
          </span>
        )}
