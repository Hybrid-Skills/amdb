      ...
      >
        ...
        >
          <div className={cn('flex-1 min-w-0', isHorizontal ? 'p-3 sm:p-4' : 'p-2')}>
            ...
            {/* Vertical referrer tag (below title) */}
              ...
              <div className="mt-1 mb-0.5">
                {recommendationLabel && LABEL_CONFIG[recommendationLabel] ? (
                  ...
                  <div className="inline-flex items-center gap-1 text-[10px] text-white/50 font-semibold">
                    <span
                      className="w-3.5 h-3.5 rounded-full flex items-center justify-center text-[8px] font-black shrink-0 leading-none"
            ...
            {isHorizontal && (
              <div className="flex items-center gap-2.5 my-2 flex-nowrap overflow-hidden">
                {recommendationLabel && LABEL_CONFIG[recommendationLabel] ? (
                  ...
                  <>
                    <div className="inline-flex items-center justify-center w-5 h-5 rounded border border-primary/60 bg-primary/30 text-primary shrink-0">
