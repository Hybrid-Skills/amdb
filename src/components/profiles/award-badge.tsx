...
function ShieldPath() {
  return <path d="M50 4 L90 18 L90 50 Q90 78 50 96 Q10 78 10 50 L10 18 Z" />;
}

function HexPath() {
  return <path d="M50 3 L93 27.5 L93 72.5 L50 97 L7 72.5 L7 27.5 Z" />;
}

function StarPath() {
  return <path d="M50 5 L61 35 L93 35 L68 54 L78 84 L50 65 L22 84 L32 54 L7 35 L39 35 Z" />;
}
    ...
    <div className="flex flex-col items-center gap-2 group">
      <div className="relative">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <svg
            viewBox="0 0 100 100"
            className={`absolute inset-0 w-full h-full ${unlocked ? '' : 'opacity-0'}`}
          >
            <defs>
            ...
            {award.shape === 'circle' && (
              <circle cx="50" cy="50" r="46" fill={`url(#${gradId}-fill)`} />
            )}
            {award.shape === 'shield' && (
              <path
                d="M50 4 L90 18 L90 50 Q90 78 50 96 Q10 78 10 50 L10 18 Z"
                fill={`url(#${gradId}-fill)`}
              />
            )}
            {award.shape === 'hexagon' && (
              <path
                d="M50 3 L93 27.5 L93 72.5 L50 97 L7 72.5 L7 27.5 Z"
                fill={`url(#${gradId}-fill)`}
              />
            )}
            {award.shape === 'star' && (
              <path
                d="M50 5 L61 35 L93 35 L68 54 L78 84 L50 65 L22 84 L32 54 L7 35 L39 35 Z"
                fill={`url(#${gradId}-fill)`}
              />
            )}
          </svg>
          ...
          >
            ...
            {award.shape === 'shield' && (
              <path d="M50 4 L90 18 L90 50 Q90 78 50 96 Q10 78 10 50 L10 18 Z" fill="#1f2937" />
            )}
            {award.shape === 'hexagon' && (
              <path d="M50 3 L93 27.5 L93 72.5 L50 97 L7 72.5 L7 27.5 Z" fill="#1f2937" />
            )}
            {award.shape === 'star' && (
              <path
                d="M50 5 L61 35 L93 35 L68 54 L78 84 L50 65 L22 84 L32 54 L7 35 L39 35 Z"
      ...
      <div className="text-center max-w-[80px]">
        ...
        <p
          className={`text-[10px] mt-0.5 leading-tight ${unlocked ? 'text-white/40' : 'text-white/20'}`}
        >
          {award.unlockHint}
        </p>
      </div>
